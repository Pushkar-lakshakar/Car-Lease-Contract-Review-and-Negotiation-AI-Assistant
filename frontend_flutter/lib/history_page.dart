...
class HistoryPage extends StatefulWidget {
  ...
  const HistoryPage({super.key, this.isSelectionMode = false});
...
class _HistoryPageState extends State<HistoryPage> {
  ...
  void _startComparison() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ComparisonPage(docIds: _selectedIds.toList()),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.isSelectionMode ? "Select for Comparison" : "Analysis History"),
        centerTitle: true,
        actions: [
      ...
      floatingActionButton: (widget.isSelectionMode && _selectedIds.length >= 2)
